...
**Foundational dispositions are not technical-skill supply.** A snapshot competency typed `foundational` (Agency, Attention to Detail, Resilience, Curiosity, Communication, Collaboration, or similar) describes *how* a student works — a behavioral disposition — not *what technical skill* the student can perform. Do **not** use a foundational snapshot competency as the `matched_competency` for a **technical** career sub-competency. A student's Resilience is not supply for "Timeline management"; Agency is not "Vendor selection"; Attention to Detail is not "Quality control systems." The disposition may co-occur with the technical work, but it is not evidence the student can *do* the technical skill. If a technical sub-competency is addressed **only** through a foundational disposition, classify it **None** (`matched_competency: null`, `d_depth: 0`). Match a foundational snapshot competency only to a career sub-competency that is itself a disposition/soft-skill construct (e.g., collaboration, communication, professional conduct) — never to a technical production, analysis, or management skill.

**Same skill, not same topic.** A match requires the snapshot competency to be the *same student capability* as the sub-competency — not merely the same subject area or thematic register. "Deliver a professional presentation" is not supply for "Proposal development"; "apply design thinking as a structured process" is not "Competitive market analysis." Sharing a topic (business, branding, print) is not a match. When the only link is topical, classify **None** or **Indirect**, not Direct/Partial.
