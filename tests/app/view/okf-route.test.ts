...
vi.mock('@/lib/db/courses-queries', () => ({ getCourseByCode: async (code: string) => (code === 'GC 4800' || code === 'GC 1010') ? { code, title: code === 'GC 4800' ? 'Capstone' : 'Intro', prefix: 'GC', level: 4, track: 'print', buildsToCareer: true, catalogUrl: null } : null }));
